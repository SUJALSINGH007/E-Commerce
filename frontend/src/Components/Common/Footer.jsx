...
const Footer = () =>{
  return(
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 px-0 md:px-8">
        <div>
          ...
          <form className="flex">
            ...
            className="p-3 w-full text-sm border-t border-l border-b  border-gray-400 rounded-l-md  focus:outline-none focus:right-2 focus:ring-gray-500 transition-all" />
            <button type="submit"
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 ">
            <li>
              <Link to="#" className="hover:text-gray-800 transition-colors">Mens's Top Wear</Link>
            </li>
            <li>
              <Link to="#" className="hover:text-gray-800 transition-colors">Women's Top Wear</Link>
            </li>
            <li>
              <Link to="#" className="hover:text-gray-800 transition-colors">Mens's Bottom Wear</Link>
            </li>
            <li>
        ...
        <div>
          <h3 className="text-lg text-gray-900 mb-4 font-bold">Follow Us</h3>
          <div className="flex items-center space-x-4 mb-6">
            ...
            <a href="https://www.indtsgram.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300"> <IoLogoInstagram className="h-5 w-5"/> </a>

            <a href="https://www.x.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300"> <RiTwitterXLine className="h-5 w-5"/> </a>
          </div>
          <p className="text-gray-900 font-bold">Call Us</p>
          <p> <TbFilePhone  className="h-5 w-5 inline-block mr-2"/>
            +91 9453511111 </p>
        </div>
      </div>
      {/* footer bottom */}
      <div className="container mx-auto mt-12 px-3 lg:px-0 border-t border-gray-200 pt-6">
